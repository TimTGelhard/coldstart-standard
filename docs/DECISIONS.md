...
- **Memory model** — three indexes over three folders, indexes derived by scanning, and the machinery deliberately not built · [decisions/memory-model.md](decisions/memory-model.md) · 9 entries · 2026-08-21
