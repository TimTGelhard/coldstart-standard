...
- **Commands** — three commands, the payload layout they ship in, and the close's rules: refuse on red, never write a restrictive mode · [decisions/commands.md](decisions/commands.md) · 7 entries · 2026-08-21
